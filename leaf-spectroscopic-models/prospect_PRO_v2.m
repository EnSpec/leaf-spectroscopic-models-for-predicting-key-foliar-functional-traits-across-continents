...
function LRT=prospect_PRO_v2(N,Cab,Car,Ant,Brown,Cw,Cm,Prot,CBC,Bspec)
...
Thetai = 15; % incident angle
Thetas = 15; % illumination zenith angle
refl = cosd(Thetai)/cosd(Thetas)*(refl+Bspec);
